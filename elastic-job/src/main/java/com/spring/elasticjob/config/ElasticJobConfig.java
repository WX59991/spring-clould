...
import com.spring.elasticjob.job.MyDataflowJob;
...
public class ElasticJobConfig {
    ...
    public JobScheduler DataFlowJobScheduler(final MyDataflowJob myDataflowJob,
                                             @Value("${myDataflowJob.cron}") final String cron,
        ...
        return new SpringJobScheduler(myDataflowJob, zookeeperRegistryCenter, getDataFlowJobConfiguration(myDataflowJob.getClass()
    ...
    public LiteJobConfiguration getDataFlowJobConfiguration(final Class<? extends DataflowJob> jobClass,
                                                        final String cron,
                                                        final int shardingTotalCount,
                                                        final String shardingItemParameters) {
        return LiteJobConfiguration.
